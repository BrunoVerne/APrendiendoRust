...
mod tests {
    ...
    #[test]
    fn test_get_no_existente() {
        let store = store_vacio();
        let salida = ejecutar("get noexiste\n", store);
        assert_eq!(salida, "ERROR: NOT FOUND\n");
    }
    ...
    fn test_comando_desconocido() {
        let store = store_vacio();
        let salida = ejecutar("delete clave\n", store);
        assert_eq!(salida, "ERROR: UNKNOWN COMMAND\n");
    }

    #[test]
    fn test_argumento_extra() {
        let store = store_vacio();
        let salida = ejecutar("set a b c\n", store);
        assert_eq!(salida, "ERROR: EXTRA ARGUMENT\n");
    }

    #[test]
    fn test_missing_argument() {
        let store = store_vacio();
        let salida = ejecutar("get\n", store);
        assert_eq!(salida, "ERROR: MISSING ARGUMENT\n");
    }
